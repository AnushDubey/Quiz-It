  ...
  return (
    <Dialog >
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Hey there, welcome to Quiz-It!</DialogTitle>
          <DialogDescription>
            ...
            <p className="my-2 mt-4 ">
              Tired of boring quizzes? Say hello to Quiz-It! The one platform for getting fantastic quizzes on any topic, with the help of artificial intelligence
            </p>
            <hr />
